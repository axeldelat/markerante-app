          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image
                  className="h-12"
                  src="https://tailwindui.com/Image/logos/tuple-logo-gray-400.svg"
                  alt="Tuple"
                  layout="fill"
                  />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image
                  className="h-12" 
                  src="https://tailwindui.com/Image/logos/mirage-logo-gray-400.svg"
                  alt="Mirage"
                  layout="fill"
                  />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <Image
                  className="h-12"
                  src="https://tailwindui.com/Image/logos/statickit-logo-gray-400.svg"
                  alt="StaticKit"
                  layout="fill"
                />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 md:col-start-2 lg:col-span-1">
                <Image
                  className="h-12"
                  src="https://tailwindui.com/Image/logos/transistor-logo-gray-400.svg"
                  alt="Transistor"
                  layout="fill"
                />
              </div>
              <div className="col-span-2 flex justify-center md:col-span-2 md:col-start-4 lg:col-span-1">
                <Image
                  className="h-12"
                  src="https://tailwindui.com/Image/logos/workcation-logo-gray-400.svg"
                  alt="Workcation"
                  layout="fill"
                />
              </div>
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0">
                <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                  <Image
                    ...
                    src="https://tailwindui.com/Image/component-images/inbox-app-screenshot-1.jpg"
              ...
              <div className="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
                <div className="pr-4 -ml-48 sm:pr-6 md:-ml-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                  <Image
                    ...
                    src="https://tailwindui.com/Image/component-images/inbox-app-screenshot-2.jpg"
